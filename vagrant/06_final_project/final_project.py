...
def view_menu_json(restaurant_id):
...
@app.route("/restaurants/<int:restaurant_id>/menu/JSON/<int:menu_item_id>")
def view_menu_item_json(restaurant_id, menu_item_id):
